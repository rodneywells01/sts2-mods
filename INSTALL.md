...
2. **Download `RandomCharacterBlacklist-0.1.1.zip`.** Use the ZIP provided by Rodney or the matching asset under [GitHub Releases](https://github.com/rodneywells01/sts2-mods/releases). Do **not** download “Source code” or use the green Code button. If no installer asset is listed, the release is still a draft; ask Rodney for the ZIP.
...
4. **Double-click `Install.cmd`.** It finds your Steam installation. Wait for **“Installed Random Character Options 0.1.1”**. If it asks for the game folder, follow “Find the game folder” below. An error message means installation has not completed.
